...
<form name="partyhallForm" id="partyhallForm" method="post" action="reserve-exec.php?id=<?php echo $_SESSION['SESS_MEMBER_ID'];?>" onsubmit="return partyhallValidate(this)">
    <table align="center" width="320">
        <CAPTION><h2>Đặt phòng tiệc</h2></CAPTION>
        <tr>
            <td><b>Tên phòng tiệc:</b></td>
            <td>
            <select name="partyhall" id="partyhall">
            <option value="select">- Chọn phòng tiệc -</option>
            <?php 
        ...
        <tr>
            <td><b>Ngày:</b></td><td><input type="date" placeholder="yyyy-mm-dd" name="date" id="date" /></td></tr>
        <tr>
            <td><b>Giờ:</b></td><td><input type="time" name="time" id="time" />
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center"><input type="submit" value="Đặt phòng"></td>
        </tr>
    </table>
</form>
</div>
